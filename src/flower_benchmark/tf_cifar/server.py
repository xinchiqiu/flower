...
from . import DEFAULT_GRPC_SERVER_ADDRESS, DEFAULT_GRPC_SERVER_PORT, NUM_CLASS, SEED
...
def main() -> None:
    ...
    xy_partitions, xy_test = tf_cifar_partitioned.load_data(
        iid_fraction=0.0, num_partitions=1, cifar100=NUM_CLASS == 100
    )
    ...
    model = resnet50v2(input_shape=(32, 32, 3), num_classes=NUM_CLASS, seed=SEED)
    ...
    strategy = flwr.strategy.DefaultStrategy(
        ...
        eval_fn=get_eval_fn(model=model, num_classes=NUM_CLASS, xy_test=xy_test),
